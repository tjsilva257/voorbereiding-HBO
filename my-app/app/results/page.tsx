  ...
  useEffect(() => {
    ...
    fetch(`/api/studies?traits=${traitsParam}`)
      ...
      .then(data => {
        ...
        const topMatches = sortedMatches.filter((m: CareerMatch) => m.matchScore === sortedMatches[0]?.matchScore);
              ...
              className={`
                ...
                ${
                  selectedRecommendation === match.study
                    ...
                    : match.matchScore === 0
                    ? 'bg-linear-to-br from-gray-600 to-gray-700 border-gray-500'
            ...
            >
              <div className="mb-4">
                <div className={`text-4xl font-bold ${
                  match.matchScore === 0 ? 'text-gray-400' : 'text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-500'
                }`}>
                  {match.matchScore}%
                </div>
